...
public class Test {
  ...
  public static void main(String... args) {
    Iterator it;
    Test interQuartileRange = new Test();
    ...
    if (elements.length != n) {
      ...
      double lowerQuartile =
          interQuartileRange.dividefirstHalf(firstHalf_elements, summation_frequency_firstHalf);
      ...
      double upperQuartile =
          interQuartileRange.divideSecondHalf(secondHalf_elements, summation_frequency_secondHalf);
